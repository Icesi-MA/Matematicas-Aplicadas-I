...
Este Jupyter Book reúne el material académico del curso **Matemáticas Aplicadas I** de la **Universidad Icesi**. Su propósito es ofrecer a los estudiantes un recurso organizado, interactivo y reproducible para el estudio de los conceptos, métodos y aplicaciones abordados durante el curso.
